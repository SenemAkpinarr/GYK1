...
public class VoiceActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private final String filepath = Environment.getExternalStorageDirectory().getPath()+"record.3gp";
            ...
            private static final int REQUEST_AUDIO_PERMISSON_CODE =200;
    ...
    private void initialize(){
        ...
        recordVoiceBtn =findViewById(R.id.record_voice_button);
        recordVoiceBtn.setOnClickListener(this);

        stopVoiceBtn=findViewById(R.id.stop_voice_button);
        stopVoiceBtn.setOnClickListener(this);

        playVoiceBtn = findViewById(R.id.play_voice_button);
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            case REQUEST_AUDIO_PERMISSON_CODE:
    ...
    private void requestPermissions() {
        ActivityCompat.requestPermissions(VoiceActivity.this, new String[]{RECORD_AUDIO, WRITE_EXTERNAL_STORAGE}, REQUEST_AUDIO_PERMISSON_CODE);
    }
}
